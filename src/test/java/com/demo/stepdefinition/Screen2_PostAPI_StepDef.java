...
public class Screen2_PostAPI_StepDef extends BaseClass {
	Logger logger = LogManager.getLogger(Screen2_PostAPI_StepDef.class);
	...
	@Given("user create a record")
	public void user_creates_a_record(DataTable requestData) {
		System.out.println(baseURL+Const.CREATE_USER);
		try {
			List<Map<String, String>> listData = requestData.asMaps(String.class, String.class);
			response = doPost(CommonSteps.methodName, baseURL, Const.CREATE_USER,
